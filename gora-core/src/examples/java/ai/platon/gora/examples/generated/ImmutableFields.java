...
public class ImmutableFields extends PersistentBase implements org.apache.avro.specific.SpecificRecord, Persistent {
  ...
  public static ImmutableFields.Builder newBuilder() {
    return new ImmutableFields.Builder();
  }
  
  /** Creates a new ImmutableFields RecordBuilder by copying an existing Builder */
  public static ImmutableFields.Builder newBuilder(ImmutableFields.Builder other) {
    return new ImmutableFields.Builder(other);
  }
  
  /** Creates a new ImmutableFields RecordBuilder by copying an existing ImmutableFields instance */
  public static ImmutableFields.Builder newBuilder(ImmutableFields other) {
    return new ImmutableFields.Builder(other);
  }
  
  @Override
  public ImmutableFields clone() {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ImmutableFields>
    ...
    private Builder() {
      super(ImmutableFields.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(ImmutableFields.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing ImmutableFields instance */
    private Builder(ImmutableFields other) {
            super(ImmutableFields.SCHEMA$);
      ...
      if (isValidValue(fields()[1], other.v2)) {
        this.v2 = (V2) data().deepCopy(fields()[1].schema(), other.v2);
    ...
    /** Sets the value of the 'v1' field */
    public ImmutableFields.Builder setV1(int value) {
    ...
    public ImmutableFields.Builder clearV1() {
    ...
    /** Sets the value of the 'v2' field */
    public ImmutableFields.Builder setV2(V2 value) {
    ...
    public ImmutableFields.Builder clearV2() {
      v2 = null;
    ...
    public ImmutableFields build() {
      try {
        ...
        record.v2 = fieldSetFlags()[1] ? this.v2 : (V2) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
  ...
  public static final class Tombstone extends ImmutableFields implements ai.platon.gora.persistency.Tombstone {

...
public class TokenDatum extends PersistentBase implements org.apache.avro.specific.SpecificRecord, Persistent {
  ...
  public static TokenDatum.Builder newBuilder() {
    return new TokenDatum.Builder();
  }
  
  /** Creates a new TokenDatum RecordBuilder by copying an existing Builder */
  public static TokenDatum.Builder newBuilder(TokenDatum.Builder other) {
    return new TokenDatum.Builder(other);
  }
  
  /** Creates a new TokenDatum RecordBuilder by copying an existing TokenDatum instance */
  public static TokenDatum.Builder newBuilder(TokenDatum other) {
    return new TokenDatum.Builder(other);
  }
  
  @Override
  public TokenDatum clone() {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TokenDatum>
    ...
    private Builder() {
      super(TokenDatum.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(TokenDatum.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing TokenDatum instance */
    private Builder(TokenDatum other) {
            super(TokenDatum.SCHEMA$);
    ...
    /** Sets the value of the 'count' field */
    public TokenDatum.Builder setCount(int value) {
    ...
    public TokenDatum.Builder clearCount() {
  ...
  public static final class Tombstone extends TokenDatum implements ai.platon.gora.persistency.Tombstone {

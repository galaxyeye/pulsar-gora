...
public class WebPage extends PersistentBase implements org.apache.avro.specific.SpecificRecord, Persistent {
  ...
  public void put(int field$, java.lang.Object value) {
    ...
    case 2: this.parsedContent = (java.util.List<java.lang.CharSequence>)((value instanceof Dirtyable) ? value : new DirtyListWrapper((java.util.List)value)); break;
    case 3: this.outlinks = (java.util.Map<java.lang.CharSequence,java.lang.CharSequence>)((value instanceof Dirtyable) ? value : new DirtyMapWrapper((java.util.Map)value)); break;
    ...
    case 6: this.byteData = (java.util.Map<java.lang.CharSequence,java.nio.ByteBuffer>)((value instanceof Dirtyable) ? value : new DirtyMapWrapper((java.util.Map)value)); break;
    case 7: this.stringData = (java.util.Map<java.lang.CharSequence,java.lang.CharSequence>)((value instanceof Dirtyable) ? value : new DirtyMapWrapper((java.util.Map)value)); break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WebPage>
    ...
    /** Sets the value of the 'url' field */
    public WebPage.Builder setUrl(java.lang.CharSequence value) {
    ...
    /** Sets the value of the 'content' field */
    public WebPage.Builder setContent(java.nio.ByteBuffer value) {
    ...
    /** Sets the value of the 'parsedContent' field */
    public WebPage.Builder setParsedContent(java.util.List<java.lang.CharSequence> value) {
    ...
    /** Sets the value of the 'outlinks' field */
    public WebPage.Builder setOutlinks(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /** Sets the value of the 'headers' field */
    public WebPage.Builder setHeaders(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /** Sets the value of the 'byteData' field */
    public WebPage.Builder setByteData(java.util.Map<java.lang.CharSequence,java.nio.ByteBuffer> value) {
    ...
    /** Sets the value of the 'stringData' field */
    public WebPage.Builder setStringData(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    public WebPage build() {
      try {
        ...
        record.parsedContent = fieldSetFlags()[2] ? this.parsedContent : (java.util.List<java.lang.CharSequence>) new DirtyListWrapper((java.util.List)defaultValue(fields()[2]));
        record.outlinks = fieldSetFlags()[3] ? this.outlinks : (java.util.Map<java.lang.CharSequence,java.lang.CharSequence>) new DirtyMapWrapper((java.util.Map)defaultValue(fields()[3]));
        ...
        record.byteData = fieldSetFlags()[6] ? this.byteData : (java.util.Map<java.lang.CharSequence,java.nio.ByteBuffer>) new DirtyMapWrapper((java.util.Map)defaultValue(fields()[6]));
        record.stringData = fieldSetFlags()[7] ? this.stringData : (java.util.Map<java.lang.CharSequence,java.lang.CharSequence>) new DirtyMapWrapper((java.util.Map)defaultValue(fields()[7]));
        return record;
      } catch (Exception e) {

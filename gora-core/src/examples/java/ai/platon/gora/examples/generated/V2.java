...
public class V2 extends PersistentBase implements org.apache.avro.specific.SpecificRecord, Persistent {
  ...
  public static V2.Builder newBuilder() {
    return new V2.Builder();
  }
  
  /** Creates a new V2 RecordBuilder by copying an existing Builder */
  public static V2.Builder newBuilder(V2.Builder other) {
    return new V2.Builder(other);
  }
  
  /** Creates a new V2 RecordBuilder by copying an existing V2 instance */
  public static V2.Builder newBuilder(V2 other) {
    return new V2.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<V2>
    ...
    private Builder(V2.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing V2 instance */
    private Builder(V2 other) {
            super(V2.SCHEMA$);
    ...
    /** Sets the value of the 'v3' field */
    public V2.Builder setV3(int value) {
  ...
  public static final class Tombstone extends V2 implements ai.platon.gora.persistency.Tombstone {

...
public class DataStoreFactory{
  ...
  public static String findProperty(Properties properties
    ...
    while(true) {
      String fullKey = GORA + "." + StringUtils.getClassname(clazz).toLowerCase(Locale.getDefault()) + "." + baseKey;
   ...
   * @param store {@link DataStore} object to get the mapping for.
   ...
   *
   * @param properties Properties which hold keys from which we can obtain values for datastore mappings.
   * @param store Data store {@link DataStore} object to get default schema name.
   */

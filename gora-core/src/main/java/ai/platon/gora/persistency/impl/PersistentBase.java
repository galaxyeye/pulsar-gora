...
*/
package ai.platon.gora.persistency.impl;
...
public abstract class PersistentBase extends SpecificRecordBase implements
   ...
   * Since {@link PersistentBase} implements {@link java.io.Externalizable},
   ...
   * Since {@link PersistentBase} implements {@link java.io.Externalizable}
   * and when actual deserialization happens for {@link PersistentBase}

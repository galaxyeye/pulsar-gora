...
public class Metadata extends PersistentBase implements org.apache.avro.specific.SpecificRecord, Persistent {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Metadata\",\"namespace\":\"ai.platon.gora.examples.generated\",\"fields\":[{\"name\":\"version\",\"type\":\"int\",\"default\":0},{\"name\":\"data\",\"type\":{\"type\":\"map\",\"values\":\"string\"},\"default\":{}}]}");
  ...
  private int version;
  private java.util.Map<CharSequence, CharSequence> data;
  ...
  public void put(int field$, Object value) {
    switch (field$) {
    case 0: this.version = (Integer)(value); break;
    case 1: this.data = (java.util.Map<CharSequence, CharSequence>)((value instanceof Dirtyable) ? value : new DirtyMapWrapper((java.util.Map)value)); break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.Map<CharSequence, CharSequence> getData() {
    return data;
  }
   ...
   * @param value the value to set.
   */
  public void setData(java.util.Map<CharSequence, CharSequence> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Metadata>
    ...
    private Builder(Metadata other) {
      ...
      if (isValidValue(fields()[1], other.data)) {
        this.data = (java.util.Map<CharSequence, CharSequence>) data().deepCopy(fields()[1].schema(), other.data);
    ...
    /** Sets the value of the 'data' field */
    public Builder setData(java.util.Map<CharSequence, CharSequence> value) {
    ...
    public Metadata build() {
      try {
        ...
        record.data = fieldSetFlags()[1] ? this.data : (java.util.Map<CharSequence, CharSequence>) new DirtyMapWrapper((java.util.Map)defaultValue(fields()[1]));
        return record;
      } catch (Exception e) {
  ...
  public static final class Tombstone extends Metadata implements ai.platon.gora.persistency.Tombstone {

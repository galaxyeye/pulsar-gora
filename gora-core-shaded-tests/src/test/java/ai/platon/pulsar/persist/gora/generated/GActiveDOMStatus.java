...
public class GActiveDOMStatus extends ai.platon.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, ai.platon.gora.persistency.Persistent {
  ...
  public void put(int field$, Object value) {
    switch (field$) {
    case 0: n = (Integer)(value); break;
    case 1: scroll = (Integer)(value); break;
    case 2: st = (CharSequence)(value); break;
    case 3: r = (CharSequence)(value); break;
    case 4: idl = (CharSequence)(value); break;
    case 5: ec = (CharSequence)(value); break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @param value the value to set.
   */
  public void setSt(CharSequence value) {
    this.st = value;
    setDirty(2);
  }
   ...
   * @param value the value to set.
   */
  public void setIdl(CharSequence value) {
    this.idl = value;
    setDirty(4);
  }
   ...
   * @param value the value to set.
   */
  public void setEc(CharSequence value) {
    this.ec = value;
    setDirty(5);
  }
  ...
  public static Builder newBuilder(GActiveDOMStatus other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GActiveDOMStatus>
    ...
    private Builder(GActiveDOMStatus other) {
            super(GActiveDOMStatus.SCHEMA$);
      if (isValidValue(fields()[0], other.n)) {
        this.n = (Integer) data().deepCopy(fields()[0].schema(), other.n);
        fieldSetFlags()[0] = true;
      }
      if (isValidValue(fields()[1], other.scroll)) {
        this.scroll = (Integer) data().deepCopy(fields()[1].schema(), other.scroll);
        fieldSetFlags()[1] = true;
      }
      if (isValidValue(fields()[2], other.st)) {
        this.st = (CharSequence) data().deepCopy(fields()[2].schema(), other.st);
        fieldSetFlags()[2] = true;
      }
      if (isValidValue(fields()[3], other.r)) {
        this.r = (CharSequence) data().deepCopy(fields()[3].schema(), other.r);
        fieldSetFlags()[3] = true;
      }
      if (isValidValue(fields()[4], other.idl)) {
        this.idl = (CharSequence) data().deepCopy(fields()[4].schema(), other.idl);
        fieldSetFlags()[4] = true;
      }
      if (isValidValue(fields()[5], other.ec)) {
        this.ec = (CharSequence) data().deepCopy(fields()[5].schema(), other.ec);
    ...
    /** Sets the value of the 'st' field */
    public Builder setSt(CharSequence value) {
    ...
    /** Sets the value of the 'idl' field */
    public Builder setIdl(CharSequence value) {
    ...
    /** Sets the value of the 'ec' field */
    public Builder setEc(CharSequence value) {
    ...
    public GActiveDOMStatus build() {
      try {
        ...
        record.n = fieldSetFlags()[0] ? this.n : (Integer) defaultValue(fields()[0]);
        record.scroll = fieldSetFlags()[1] ? this.scroll : (Integer) defaultValue(fields()[1]);
        record.st = fieldSetFlags()[2] ? this.st : (CharSequence) defaultValue(fields()[2]);
        record.r = fieldSetFlags()[3] ? this.r : (CharSequence) defaultValue(fields()[3]);
        record.idl = fieldSetFlags()[4] ? this.idl : (CharSequence) defaultValue(fields()[4]);
        record.ec = fieldSetFlags()[5] ? this.ec : (CharSequence) defaultValue(fields()[5]);
        return record;
      } catch (Exception e) {

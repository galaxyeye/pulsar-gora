...
public class GFieldGroup extends ai.platon.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, ai.platon.gora.persistency.Persistent {
  ...
  public void put(int field$, Object value) {
    ...
    case 3: fields = (java.util.Map<CharSequence, CharSequence>)((value instanceof ai.platon.gora.persistency.Dirtyable) ? value : new ai.platon.gora.persistency.impl.DirtyMapWrapper((java.util.Map)value)); break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static Builder newBuilder(GFieldGroup other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GFieldGroup>
    ...
    /** Sets the value of the 'fields' field */
    public Builder setFields(java.util.Map<CharSequence, CharSequence> value) {
    ...
    public GFieldGroup build() {
      try {
        ...
        record.fields = fieldSetFlags()[3] ? this.fields : (java.util.Map<CharSequence, CharSequence>) new ai.platon.gora.persistency.impl.DirtyMapWrapper((java.util.Map)defaultValue(fields()[3]));
        return record;
      } catch (Exception e) {

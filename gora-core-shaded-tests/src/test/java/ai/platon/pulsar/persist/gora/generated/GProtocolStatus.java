...
public class GProtocolStatus extends ai.platon.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, ai.platon.gora.persistency.Persistent {
  ...
  public void put(int field$, Object value) {
    ...
    case 2: args = (java.util.Map<CharSequence, CharSequence>)((value instanceof ai.platon.gora.persistency.Dirtyable) ? value : new ai.platon.gora.persistency.impl.DirtyMapWrapper((java.util.Map)value)); break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static Builder newBuilder(GProtocolStatus other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GProtocolStatus>
    ...
    /** Sets the value of the 'args' field */
    public Builder setArgs(java.util.Map<CharSequence, CharSequence> value) {
    ...
    public GProtocolStatus build() {
      try {
        ...
        record.args = fieldSetFlags()[2] ? this.args : (java.util.Map<CharSequence, CharSequence>) new ai.platon.gora.persistency.impl.DirtyMapWrapper((java.util.Map)defaultValue(fields()[2]));
        return record;
      } catch (Exception e) {

...
public class GPageModel extends ai.platon.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, ai.platon.gora.persistency.Persistent {
  ...
  private java.util.List<GFieldGroup> fieldGroups;
  ...
  public void put(int field$, Object value) {
    switch (field$) {
    case 0: fieldGroups = (java.util.List<GFieldGroup>)((value instanceof ai.platon.gora.persistency.Dirtyable) ? value : new ai.platon.gora.persistency.impl.DirtyListWrapper((java.util.List)value)); break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<GFieldGroup> getFieldGroups() {
    return fieldGroups;
  }
   ...
   */
  public void setFieldGroups(java.util.List<GFieldGroup> value) {
  ...
  public static Builder newBuilder(GPageModel other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GPageModel>
    ...
    private Builder(GPageModel other) {
            super(GPageModel.SCHEMA$);
      if (isValidValue(fields()[0], other.fieldGroups)) {
        this.fieldGroups = (java.util.List<GFieldGroup>) data().deepCopy(fields()[0].schema(), other.fieldGroups);
    ...
    /** Sets the value of the 'fieldGroups' field */
    public Builder setFieldGroups(java.util.List<GFieldGroup> value) {
    ...
    public GPageModel build() {
      try {
        ...
        record.fieldGroups = fieldSetFlags()[0] ? this.fieldGroups : (java.util.List<GFieldGroup>) new ai.platon.gora.persistency.impl.DirtyListWrapper((java.util.List)defaultValue(fields()[0]));
        return record;
      } catch (Exception e) {

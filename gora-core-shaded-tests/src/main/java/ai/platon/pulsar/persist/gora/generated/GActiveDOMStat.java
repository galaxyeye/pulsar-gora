...
public class GActiveDOMStat extends ai.platon.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, ai.platon.gora.persistency.Persistent {
  ...
  public void put(int field$, Object value) {
    switch (field$) {
    case 0: ni = (Integer)(value); break;
    case 1: na = (Integer)(value); break;
    case 2: nnm = (Integer)(value); break;
    case 3: nst = (Integer)(value); break;
    case 4: w = (Integer)(value); break;
    case 5: h = (Integer)(value); break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @param value the value to set.
   */
  public void setNnm(Integer value) {
    this.nnm = value;
    setDirty(2);
  }
   ...
   * @param value the value to set.
   */
  public void setNst(Integer value) {
    this.nst = value;
    setDirty(3);
  }
  ...
  public static Builder newBuilder(GActiveDOMStat other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GActiveDOMStat>
    ...
    private Builder(GActiveDOMStat other) {
            super(GActiveDOMStat.SCHEMA$);
      if (isValidValue(fields()[0], other.ni)) {
        this.ni = (Integer) data().deepCopy(fields()[0].schema(), other.ni);
        fieldSetFlags()[0] = true;
      }
      if (isValidValue(fields()[1], other.na)) {
        this.na = (Integer) data().deepCopy(fields()[1].schema(), other.na);
        fieldSetFlags()[1] = true;
      }
      if (isValidValue(fields()[2], other.nnm)) {
        this.nnm = (Integer) data().deepCopy(fields()[2].schema(), other.nnm);
        fieldSetFlags()[2] = true;
      }
      if (isValidValue(fields()[3], other.nst)) {
        this.nst = (Integer) data().deepCopy(fields()[3].schema(), other.nst);
        fieldSetFlags()[3] = true;
      }
      if (isValidValue(fields()[4], other.w)) {
        this.w = (Integer) data().deepCopy(fields()[4].schema(), other.w);
        fieldSetFlags()[4] = true;
      }
      if (isValidValue(fields()[5], other.h)) {
        this.h = (Integer) data().deepCopy(fields()[5].schema(), other.h);
    ...
    /** Sets the value of the 'nnm' field */
    public Builder setNnm(int value) {
    ...
    /** Sets the value of the 'nst' field */
    public Builder setNst(int value) {
    ...
    public GActiveDOMStat build() {
      try {
        ...
        record.ni = fieldSetFlags()[0] ? this.ni : (Integer) defaultValue(fields()[0]);
        record.na = fieldSetFlags()[1] ? this.na : (Integer) defaultValue(fields()[1]);
        record.nnm = fieldSetFlags()[2] ? this.nnm : (Integer) defaultValue(fields()[2]);
        record.nst = fieldSetFlags()[3] ? this.nst : (Integer) defaultValue(fields()[3]);
        record.w = fieldSetFlags()[4] ? this.w : (Integer) defaultValue(fields()[4]);
        record.h = fieldSetFlags()[5] ? this.h : (Integer) defaultValue(fields()[5]);
        return record;
      } catch (Exception e) {

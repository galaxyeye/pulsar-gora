 ...
 */
package ai.platon.gora.examples.generated;
...
public class WebPage extends PersistentBase implements org.apache.avro.specific.SpecificRecord, Persistent {
  ...
  private java.util.List<CharSequence> parsedContent;
  private java.util.Map<CharSequence, CharSequence> outlinks;
  private java.util.Map<CharSequence, CharSequence> headers;
  private Metadata metadata;
  private java.util.Map<CharSequence,java.nio.ByteBuffer> byteData;
  private java.util.Map<CharSequence, CharSequence> stringData;
  ...
  public void put(int field$, Object value) {
    switch (field$) {
    case 0: this.url = (CharSequence)(value); break;
    case 1: this.content = (java.nio.ByteBuffer)(value); break;
    case 2: this.parsedContent = (java.util.List<CharSequence>)((value instanceof Dirtyable) ? value : new DirtyListWrapper((java.util.List)value)); break;
    case 3: this.outlinks = (java.util.Map<CharSequence, CharSequence>)((value instanceof Dirtyable) ? value : new DirtyMapWrapper((java.util.Map)value)); break;
    case 4: this.headers = (java.util.Map<CharSequence, CharSequence>)(value); break;
    case 5: this.metadata = (Metadata)(value); break;
    case 6: this.byteData = (java.util.Map<CharSequence,java.nio.ByteBuffer>)((value instanceof Dirtyable) ? value : new DirtyMapWrapper((java.util.Map)value)); break;
    case 7: this.stringData = (java.util.Map<CharSequence, CharSequence>)((value instanceof Dirtyable) ? value : new DirtyMapWrapper((java.util.Map)value)); break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<CharSequence> getParsedContent() {
   ...
   * @param value the value to set.
   */
  public void setParsedContent(java.util.List<CharSequence> value) {
   ...
   */
  public java.util.Map<CharSequence,java.nio.ByteBuffer> getByteData() {
    return byteData;
  }
   ...
   * @param value the value to set.
   */
  public void setByteData(java.util.Map<CharSequence,java.nio.ByteBuffer> value) {
   ...
   */
  public java.util.Map<CharSequence, CharSequence> getStringData() {
    return stringData;
  }
   ...
   * @param value the value to set.
   */
  public void setStringData(java.util.Map<CharSequence, CharSequence> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WebPage>
    ...
    private Builder(WebPage other) {
      ...
      if (isValidValue(fields()[2], other.parsedContent)) {
        this.parsedContent = (java.util.List<CharSequence>) data().deepCopy(fields()[2].schema(), other.parsedContent);
        fieldSetFlags()[2] = true;
      }
      if (isValidValue(fields()[3], other.outlinks)) {
        this.outlinks = (java.util.Map<CharSequence, CharSequence>) data().deepCopy(fields()[3].schema(), other.outlinks);
        fieldSetFlags()[3] = true;
      }
      if (isValidValue(fields()[4], other.headers)) {
        this.headers = (java.util.Map<CharSequence, CharSequence>) data().deepCopy(fields()[4].schema(), other.headers);
      ...
      if (isValidValue(fields()[6], other.byteData)) {
        this.byteData = (java.util.Map<CharSequence,java.nio.ByteBuffer>) data().deepCopy(fields()[6].schema(), other.byteData);
        fieldSetFlags()[6] = true;
      }
      if (isValidValue(fields()[7], other.stringData)) {
        this.stringData = (java.util.Map<CharSequence, CharSequence>) data().deepCopy(fields()[7].schema(), other.stringData);
    ...
    /** Sets the value of the 'parsedContent' field */
    public Builder setParsedContent(java.util.List<CharSequence> value) {
    ...
    public Builder clearParsedContent() {
      parsedContent = null;
    ...
    /** Sets the value of the 'byteData' field */
    public Builder setByteData(java.util.Map<CharSequence,java.nio.ByteBuffer> value) {
    ...
    /** Sets the value of the 'stringData' field */
    public Builder setStringData(java.util.Map<CharSequence, CharSequence> value) {
    ...
    public WebPage build() {
      try {
        ...
        record.parsedContent = fieldSetFlags()[2] ? this.parsedContent : (java.util.List<CharSequence>) new DirtyListWrapper((java.util.List)defaultValue(fields()[2]));
        record.outlinks = fieldSetFlags()[3] ? this.outlinks : (java.util.Map<CharSequence, CharSequence>) new DirtyMapWrapper((java.util.Map)defaultValue(fields()[3]));
        record.headers = fieldSetFlags()[4] ? this.headers : (java.util.Map<CharSequence, CharSequence>) defaultValue(fields()[4]);
        record.metadata = fieldSetFlags()[5] ? this.metadata : (Metadata) Metadata.newBuilder().build();
        record.byteData = fieldSetFlags()[6] ? this.byteData : (java.util.Map<CharSequence,java.nio.ByteBuffer>) new DirtyMapWrapper((java.util.Map)defaultValue(fields()[6]));
        record.stringData = fieldSetFlags()[7] ? this.stringData : (java.util.Map<CharSequence, CharSequence>) new DirtyMapWrapper((java.util.Map)defaultValue(fields()[7]));
        return record;
      } catch (Exception e) {
  ...
  public static final class Tombstone extends WebPage implements ai.platon.gora.persistency.Tombstone {

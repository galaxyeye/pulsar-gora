...
public class Employee extends PersistentBase implements org.apache.avro.specific.SpecificRecord, Persistent {
  ...
  public void put(int field$, Object value) {
    switch (field$) {
    case 0: this.name = (CharSequence)(value); break;
    case 1: this.dateOfBirth = (Long)(value); break;
    case 2: this.ssn = (CharSequence)(value); break;
    case 3: this.salary = (Integer)(value); break;
    case 4: this.boss = (Object)(value); break;
    case 5: this.value = (CharSequence)(value); break;
    case 6: this.webpage = (WebPage)(value); break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @param value the value to set.
   */
  public void setSsn(CharSequence value) {
    this.ssn = value;
    setDirty(2);
  }
   ...
   * @param value the value to set.
   */
  public void setBoss(Object value) {
    this.boss = value;
    setDirty(4);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Employee>
    ...
    private Builder(Employee other) {
      ...
      if (isValidValue(fields()[1], other.dateOfBirth)) {
        this.dateOfBirth = (Long) data().deepCopy(fields()[1].schema(), other.dateOfBirth);
        fieldSetFlags()[1] = true;
      }
      if (isValidValue(fields()[2], other.ssn)) {
        this.ssn = (CharSequence) data().deepCopy(fields()[2].schema(), other.ssn);
        fieldSetFlags()[2] = true;
      }
      if (isValidValue(fields()[3], other.salary)) {
        this.salary = (Integer) data().deepCopy(fields()[3].schema(), other.salary);
        fieldSetFlags()[3] = true;
      }
      if (isValidValue(fields()[4], other.boss)) {
        this.boss = (Object) data().deepCopy(fields()[4].schema(), other.boss);
        fieldSetFlags()[4] = true;
      }
      if (isValidValue(fields()[5], other.value)) {
        this.value = (CharSequence) data().deepCopy(fields()[5].schema(), other.value);
        fieldSetFlags()[5] = true;
      }
      if (isValidValue(fields()[6], other.webpage)) {
        this.webpage = (WebPage) data().deepCopy(fields()[6].schema(), other.webpage);
    ...
    /** Sets the value of the 'ssn' field */
    public Builder setSsn(CharSequence value) {
    ...
    /** Sets the value of the 'boss' field */
    public Builder setBoss(Object value) {
    ...
    /** Sets the value of the 'webpage' field */
    public Builder setWebpage(WebPage value) {
    ...
    public Employee build() {
      try {
        ...
        record.dateOfBirth = fieldSetFlags()[1] ? this.dateOfBirth : (Long) defaultValue(fields()[1]);
        record.ssn = fieldSetFlags()[2] ? this.ssn : (CharSequence) defaultValue(fields()[2]);
        record.salary = fieldSetFlags()[3] ? this.salary : (Integer) defaultValue(fields()[3]);
        record.boss = fieldSetFlags()[4] ? this.boss : (Object) defaultValue(fields()[4]);
        record.value = fieldSetFlags()[5] ? this.value : (CharSequence) defaultValue(fields()[5]);
        record.webpage = fieldSetFlags()[6] ? this.webpage : (WebPage) defaultValue(fields()[6]);
        return record;
      } catch (Exception e) {
  ...
  public static final class Tombstone extends Employee implements ai.platon.gora.persistency.Tombstone {
